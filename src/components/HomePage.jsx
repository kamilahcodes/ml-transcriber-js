  ...
  return (
    <div>
        <main className='flex-1 p-4 flex flex-col gap-3 text-center sm:gap-4 md:gap-5 justify-center pb-20'>
            <h1 className='font-semibold text-5xl sm:text-6xl text-pink-400 bold'> Transcriber</h1>
            <h3 className='font-medium md:text-lg'>Record <span className='text-pink-400'>&rarr;</span> Transcribe <span className='text-pink-400'>&rarr;</span> Translate</h3>
            ...
            <p className='text-base'>Or  
                <label className='text-pink-400 cursor-pointer hover:text-pink-400 duration-200'> upload 
                <input onChange={(e)=> {    
